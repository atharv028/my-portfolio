...
import { CanvasRevealEffect } from "./ui/card-reveal";
  ...
  return (
    <section className="w-full py-20">
      <h1 className="heading">
        My {` `}
        <span className="text-primary text-purple">Approach</span>
      </h1>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        <h2 className="dark:text-white text-center text-xm opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200" style={{
            color: '#e4ecff'
        }}>
          {des}
        </h2>
